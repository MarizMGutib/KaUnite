          ...
          <div className="flex flex-col gap-[10px]">
            ...
            <div className="flex items-center pt-[1rem] text-l font-medium">
              ...
              <Link href="/admin/jobs">
                <span
                  className={`pl-[1.5rem] ${isActive("/admin/jobs") ? "underline" : ""}`}
                >
                  Jobs
                </span>
              </Link>
            ...
            <div className="flex items-center pt-[1rem] text-l font-medium">
              ...
              <Link href="/admin/citizens">
                <span
                  className={`pl-[1.5rem] ${isActive("/admin/citizens") ? "underline" : ""}`}
                >
                  Citizens
                </span>
              </Link>
            ...
            <div className="flex items-center pt-[1rem] text-l font-medium">
              ...
              <Link href="/admin/health">
                <span
                  className={`pl-[1.5rem] ${isActive("/admin/health") ? "underline" : ""}`}
                >
                  Health Records
                </span>
              </Link>
